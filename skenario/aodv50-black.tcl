...
set tracefd [open s-aodv250-black.tr w]
set namtrace [open s-aodv250-black.nam w]
...
# $ns_ at 0.0 "[$node_(4) set ragent_] hacker"
# $ns_ at 0.0 "[$node_(27) set ragent_] hacker"
# $ns_ at 0.0 "[$node_(36) set ragent_] hacker"
# $ns_ at 0.0 "[$node_(44) set ragent_] hacker"
