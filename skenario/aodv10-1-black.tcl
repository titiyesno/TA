...
set val(cp)             "traffic1-2"             ;# connection pattern file
set val(sc)             "scenario10-2.tcl"

set ns_	[new Simulator]				
set tracefd [open s-aodv2-black.tr w]
set namtrace [open s-aodv2-lack.nam w]
...
$node_(3) color green
$ns_ at 0.0 "$node_(3) color green"
$ns_ at 0.0 "$node_(3) label Source"
