...
set val(nn)		40				;	# Number of Mobile Nodes
...
set val(cp)             "traffic4"             ;# connection pattern file
set val(sc)             "scenario40.tcl"

set ns_	[new Simulator]				
set tracefd [open s-aodv240-worm.tr w]
set namtrace [open s-aodv240-worm.nam w]
...
# $ns_ at 0.0 "[$node_(33) set ragent_] wormhole"
# $ns_ at 0.0 "[$node_(3) set ragent_] wormhole"
# $ns_ at 0.0 "[$node_(2) set ragent_] wormhole"

$ns_ at 0.0 "[$node_(13) set ragent_] wormhole"
$ns_ at 0.0 "[$node_(26) set ragent_] wormhole"
$ns_ at 0.0 "[$node_(25) set ragent_] wormhole"
$ns_ at 0.0 "[$node_(36) set ragent_] wormhole"
