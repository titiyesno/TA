...
set val(cp)             "traffic3"             ;# connection pattern file
set val(sc)             "scenario20.tcl"

set ns_	[new Simulator]				
set tracefd [open s-aodv220-worm.tr w]
set namtrace [open s-aodv220-worm.nam w]
...
$node_(15) color green
$ns_ at 0.0 "$node_(15) color green"
$ns_ at 0.0 "$node_(15) label Source"

$node_(16) color blue
$ns_ at 0.0 "$node_(16) color blue"
$ns_ at 0.0 "$node_(16) label Destination"

# $node_(0) color red
# $ns_ at 0.0 "$node_(15) color red"
# $ns_ at 0.0 "$node_(15) label Attacker"

#$ns_ at 0.0 "[$node_(7) set ragent_] wormhole"
$ns_ at 0.0 "[$node_(0) set ragent_] wormhole"
#$ns_ at 0.0 "[$node_(8) set ragent_] wormhole"

#pasangannya sama node 0
#$ns_ at 0.0 "[$node_(2) set ragent_] wormhole"
#$ns_ at 0.0 "[$node_(3) set ragent_] wormhole"
$ns_ at 0.0 "[$node_(10) set ragent_] wormhole"
